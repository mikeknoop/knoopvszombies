...
class User {
  ...
  */
  ...
  function GetUser($uid)
  {
    ...
    $sql = "SELECT uid, email, password, fb_id, using_fb, admin, privileges, name, code_of_conduct, liability_waiver, active_game, active_squad, squad_name, created, email_confirmed, approved, forum_privileges FROM user WHERE uid='$uid'";
    $results = $GLOBALS['Db']->GetRecords($sql);
