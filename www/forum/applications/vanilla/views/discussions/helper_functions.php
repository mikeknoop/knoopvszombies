      ...
      <div class="Meta">
         ...
         <?php
            ...
            if ($Discussion->LastCommentID != '') {
               echo '<span class="LastCommentBy">'.sprintf(T('Last by %1$s'), UserAnchor($Last)).'</span>';
            ...
            {
               echo '<span class="CategortyBreadcrumb">In'.Anchor($Discussion->Category, '/categories/'.$Discussion->CategoryUrlCode, 'Category').'</span>';
            }
