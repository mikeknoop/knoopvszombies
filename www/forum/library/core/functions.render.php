...
if (!function_exists('UserAnchor')) {
   function UserAnchor($User, $CssClass = '') {
     ...
     // return '<a href="'/'.Url(DOMAIN.'/account/'.$User->UserID.'/'.urlencode($User->Name)).'"'.$CssClass.'>'.$User->Name.'</a>';
...
if (!function_exists('UserPhoto')) {
   function UserPhoto($User, $CssClass = '') {
      ...
      if ($User->Photo != '') {
         ...
         //return '<a href="'.Url(DOMAIN.'/account/'.$User->UserID.'/'.urlencode($User->Name)).'"'.$CssClass.'>'
