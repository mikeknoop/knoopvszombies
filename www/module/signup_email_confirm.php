...
<div class="signup_header_large">
  We strongly recommend you whitelist our email address, mods@osundead.com so that we can send you email without going to your spam box.
</div>

<div class="signup_header_large">
  For your convienence, here are links to common email providers:
  <ul>
  <li><a class="accent_color" href="https://webmail.oregonstate.edu">Onid email</a></li>
