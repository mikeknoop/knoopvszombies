...
<?php if ($_GET['state'] != 'pending'):?>
  ...
  Please submit a picture and name that will appear in the player list. There are two ways to do this:
  </div>
  ...
  <div class="signup_header_text">
  This will automatically connect your new account with whomever is currently logged into Facebook on this computer. You will be asked to authorize our Facebook application so we can access your username and photo. Before you proceed, make sure <span class="bold">you</span> are logged into Facebook and not someone else.
  </div>
