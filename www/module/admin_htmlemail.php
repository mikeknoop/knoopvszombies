  <?php
    if (isset($_GET['action']) && $_GET['action'] == 'send')
    {
      ...
      if ((isset($_POST['send_addresses']) && $_POST['send_addresses'] != '') && (isset($_POST['email_subject']) && $_POST['email_subject'] != '') && (isset($_POST['email_html']) && $_POST['email_html'] != ''))
      {
  ...
  <form name="email_send_form" action="http://<?php echo DOMAIN; ?>/admin/htmlemail/send" method="POST">
    ...
    <div class="email_block">
      <div class="email_form_label">HTML Body:</div>
      <div class="email_form">
        <textarea class="email_form_body" name="email_html">Hello,
...
<?php echo UNIVERSITY; ?> Humans vs. Zombies</textarea>
    ...
    <div class="email_block">
      <div class="email_form_label">Plaintext Body:</div>
      <div class="email_form">
        <textarea class="email_form_body" name="email_text">Hello,
...
<?php echo UNIVERSITY; ?> Humans vs. Zombies</textarea>
    ...
    <div class="email_block">
      <div class="email_form_label">Mailgun Campaign:</div>
      <div class="email_form"><input class="email_form_subject" type="textbox" name="campaign" value="" /></div>
      <div class="clearfix"></div>
    </div>
    <div class="email_block">
