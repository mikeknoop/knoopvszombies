  ...
  <div class="joingame_header">
    <p>Remember, we have orientation meetings setup for Humans vs. Zombies. You must attend at least one orientation session! These will aquaint you with rules, gameplay and get you geared up for the game. <a class="accent_color" href="http://<?php echo DOMAIN; ?>/orientations/<?php echo $joined_game['gid'] ?>">Click here to view a list of the orientation sessions for the <?php echo $joined_game['name'] ?> game.</a></p> 
  </div>
